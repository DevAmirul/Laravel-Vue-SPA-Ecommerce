            ...
            >
                <div class="col-lg-10 col-xl-8">
                    <div class="card" style="border-radius: 10px">
                        <div class="card-header card-header-2 px-4 py-5">
                            <h5 class="text-muted mb-0">
                                Thanks for your Orders,
                                <span style="color: #3d3d3d">Anna</span>!
                            </h5>
                        </div>
                        ...
                        >
                            <h5
                                class="d-flex align-items-center justify-content-end text-white extra-pt text-uppercase mb-0"
                            >

                                <span class="h2 mb-0 ms-2" style="color: #6c757d !important;">E-commerce</span>
                            </h5>
                        </div>
                    </div>
                </div>
