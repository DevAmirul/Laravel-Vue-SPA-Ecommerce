...
trait DashboardService {
    ...
    public function showSaleQuery($timeStr): void{
        ...
        $this->sale          = Order::where('order_status', 'delivered')->where('updated_at', '>', $this->getTime($timeStr))->count('order_status');
    }

    public function showOrdersQuery($timeStr): void{
        $this->strTimeOfOrders = $timeStr;
        $this->totalOrders     = Order::where('updated_at', '>', $this->getTime($timeStr))
    ...
    public function showRevenueQuery($timeStr): void{
        ...
        $this->revenue          = Order::where('order_status', 'delivered')->where('updated_at', '>', $this->getTime($timeStr))->sum('total');
    }
    ...
    public function newArrivalProductsQuery($timeStr): void{
        ...
        $this->newArrivalProducts = Product::where('created_at', '>', $this->getTime($timeStr))
