...
class TopSaleServices {
    ...
    public static function topSalesQuery(): object {
        return DB::table('products')
            ...
            ->select( 'products.id as p_id', 'products.name', 'products.sale_price', 'discount_prices.discount', 'products.slug', 'products.image', 'revenue_from_purchase_and_sale_of_products.revenue' )
