...
<div>
    ...
    <div wire:ignore>
        <select id="select-cate" class="form-select" name="state[]" multiple placeholder="Select categories...(optional)"
            autocomplete="off">
    ...
    <div wire:ignore>
        <select id="select-brand" class="form-select" name="state[]" multiple placeholder="Select brands...(optional)"
            autocomplete="off">
