<div>
    ...
    <h6 class="text-left text-muted fw-bolder">Showing {{ (($paginator->currentPage() * $paginator->count()) - $paginator->count()) + 1 }} to {{ $paginator->currentPage() * $paginator->count() }} of {{ $paginator->total() }} entries</h6>
    @endif
</div>