...
<div>
    ...
    <!-- End Sidebar-->
    <x-table pageTitle='Coupons Orders Report' tableName="Coupons Orders Report Table" :$columnNamesArr
        ...
        <form class="mt-2 d-flex gap-2">
            ...
            <div class="col-3"><input wire:model='startDate' class="form-control" id="start_date" type="text"
                    name="start_date" placeholder="Pick start Date" aria-label="Start Date" autocomplete="off">
            </div>
